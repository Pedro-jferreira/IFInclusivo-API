...
public class InterpreteInputDTO extends TutorInputDTO{
    ...
    public InterpreteInputDTO(Long id, String nome, String login, String senha, Long matricula, String biografia, ConfigAcblInputDTO configAcessibilidadeEntity,  String especialidade, Double salary) {

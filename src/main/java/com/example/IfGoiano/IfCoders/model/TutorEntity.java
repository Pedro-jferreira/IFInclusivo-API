...
public class TutorEntity extends UsuarioEntity {
    ...
    public TutorEntity(String nome, String login, String senha, Long matricula, String biografia, ConfigAcessibilidade configAcessibilidade, String especialidade) {

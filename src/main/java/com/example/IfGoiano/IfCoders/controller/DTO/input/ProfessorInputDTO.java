...
public class ProfessorInputDTO extends UsuarioInputDTO{
    ...
    public ProfessorInputDTO(Long id, String nome, String login, String senha, Long matricula, String biografia, ConfigAcblInputDTO configAcessibilidadeEntity,  String formacao) {
